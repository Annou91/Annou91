...
🌱 Currently learning : **Kubernetes • Ansible • AWS Solutions Architect**  
🏆 Certifications in progress : **GitLab CI/CD Associate • AWS Cloud Practitioner**  


## 🚀 My DevOps Projects

| Name | Stack | Description | Repo |
|------|-------|-------------|------|
| 📊 Monitoring Stack | Docker, Prometheus, Grafana | Application monitoring dashboard with CPU/memory alerting | [Link](#) |
| ⚙️ CI/CD Pipeline | Python, Flask, Docker, GitHub Actions | Full pipeline test → build → deploy on VPS | [Link](#) |
| ☁️ AWS IaC | Terraform, AWS, Bash | EC2 + S3 provisioning + nginx server config via Terraform | [Link](#) |
